...
Событие :doc:`УстановитьУсловноеОформление <../../func/pm/Ustanovit'_Uslovnoye_Oformleniye>` предназначено для редактирования управляемой формы основного модуля. К примеру, для установки условного оформления списка документов.
