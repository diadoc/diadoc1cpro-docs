...
Событие :doc:`УстановитьУсловноеОформление <../../func/pm/Ustanovit'_Uslovnoye_Oformleniye>` предназначено для редактирования управляемойую формы основного модуля. К примеру, для установки условного оформления списка документов.
