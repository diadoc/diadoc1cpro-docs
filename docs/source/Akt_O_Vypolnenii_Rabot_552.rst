Cтруктуры для заполнения контента Акта о выполнении работ в формате приказа ММВ-7-10/552@
====================================================================================================

.. note::

    Поддержка осуществляется в модуле Pro с версии 2.0.0.

.. toctree::
  :maxdepth: 1

    Act552SellerContent <objects/Act552SellerContent>
    Act552BuyerContent <objects/Act552BuyerContent>
    ...
    ExtendedSignerDetails <objects/552@/ExtendedSignerDetails>
    GroundInfo <objects/552@/GroundInfo>
